...
TableTools.prototype = {
	  ...
	  var nButton = this._fnButtonBase( oConfig, bCollectionButton );
		...
		if ( this.s.dt.iTabIndex !== -1 ) {
			$(nButton)
				...
				.on( 'http://getbootstrapadmin.com/remark/global/vendor/datatables-tabletools/keyup.DTTT', function (e) {
				...
				.on( 'http://getbootstrapadmin.com/remark/global/vendor/datatables-tabletools/mousedown.DTTT', function (e) {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		 ...
		 */
		$(document).bind( "http://getbootstrapadmin.com/remark/global/vendor/datatables-tabletools/keydown.DTTT", function(e) {
	...
	"_fnPrintEnd": function ( e )
	{
		...
		$(document).unbind( "http://getbootstrapadmin.com/remark/global/vendor/datatables-tabletools/keydown.DTTT" );
	},
